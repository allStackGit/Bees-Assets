...
| WebGL browser WebSocket, `dynCall`, `.jslib`, `.jspre`, Unity 6 | regressions REG-007; `Plugins/WebSocket.jslib` | `Plugins/WebSocket.jspre`, `Plugins/WebSocket.cs`, `WebSocketFactory` | browser WebSocket event → managed callback; Development WebGL build + browser console |
