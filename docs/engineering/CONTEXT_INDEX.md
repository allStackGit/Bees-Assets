...
- For client/server wire, persistence, reconnect, learning-key, or identity contracts, inspect both the Unity/client paths and `BeesServer~/` before changing the contract.
