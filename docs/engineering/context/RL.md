...
| server-controlled distributed workers, leases, canonical builds | `Training/bees_training_worker_agent.py`, `Training/bees_training_control.py` | `BeesServer~/trainingControl.js`, `BeesServer~/docs/TRAINING_CONTROL.md`, WAN/remote worker launchers |
