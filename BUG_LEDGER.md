...
The WAN actor empty-trajectory-queue crash and capped training-log flush stall were fixed. A stale duplicate-acknowledgement race found in both fixed-topology and elastic brokers was fixed, with focused regression protection added. No tests were executed, per the audit's static-only constraint.
