...
| distributed training control, leases, trainer registry, build distribution | `docs/TRAINING_CONTROL.md` | `trainingControl.js`, `trainingControlCli.js`; client `Training/bees_training_control.py`, `bees_training_worker_agent.py` | desired-state revision, dedicated fail-closed lease, full-game inference fallback, SHA-256 canonical artifacts |
