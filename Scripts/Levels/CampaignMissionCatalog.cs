    ...
    public static class CampaignMissionCatalog
    {
        ...
        public static readonly IReadOnlyList<MissionDefinition> Definitions =
            new MissionDefinition[]
            {
                ...
                new MissionDefinition(7, "Minesweeper", nameof(Level.Titania1Minesweeper), nameof(Level.Titania1Minesweeper), nameof(Level.Titania1Minesweeper), level => level.Titania1Minesweeper(), true, AutomatedScenarioStatus.InDevelopment),
