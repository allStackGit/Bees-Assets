...
public class Pool : MonoBehaviour
{
    ...
    public void Setup(Stage stage)
    {
        ...
        BargePool = new ObjectPool<Barge>(CreatePooledBarge, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        BeaconPool = new ObjectPool<Beacon>(CreatePooledBeacon, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        BeehivePool = new ObjectPool<Beehive>(CreatePooledBeehive, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        BumblebeePool = new ObjectPool<Bumblebee>(CreatePooledBumblebee, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        CarpenterBeePool = new ObjectPool<CarpenterBee>(CreatePooledCarpenterBee, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        CarrierPool = new ObjectPool<Carrier>(CreatePooledCarrier, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        CruiserPool = new ObjectPool<Cruiser>(CreatePooledCruiser, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        DreadnoughtPool = new ObjectPool<Dreadnought>(CreatePooledDreadnought, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        DronePool = new ObjectPool<Drone>(CreatePooledDrone, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        FactoryPool = new ObjectPool<Factory>(CreatePooledFactory, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        FireBargePool = new ObjectPool<FireBarge>(CreatePooledFireBarge, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        FlagshipPool = new ObjectPool<Flagship>(CreatePooledFlagship, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        FrigatePool = new ObjectPool<Frigate>(CreatePooledFrigate, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        GunshipPool = new ObjectPool<Gunship>(CreatePooledGunship, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        HoneybeePool = new ObjectPool<Honeybee>(CreatePooledHoneybee, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        HornetPool = new ObjectPool<Hornet>(CreatePooledHornet, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        LeafcutterPool = new ObjectPool<Leafcutter>(CreatePooledLeafcutter, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        QueenPool = new ObjectPool<Queen>(CreatePooledQueen, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        ScoutPool = new ObjectPool<Scout>(CreatePooledScout, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        StrikerPool = new ObjectPool<Striker>(CreatePooledStriker, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        WarpGatePool = new ObjectPool<WarpGate>(CreatePooledWarpGate, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        WaspPool = new ObjectPool<Wasp>(CreatePooledWasp, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);
        YellowJacketPool = new ObjectPool<YellowJacket>(CreatePooledYellowJacket, OnTakeShipFromPool, OnReturnShipToPool, OnDestroyPoolObject, true, 0, 50);

        PlutoMapPool = new ObjectPool<Assets.Scripts.UI_Components.Map>(CreatePooledPlutoMap, null, null, null, true, 0, 50);
        NeptuneMapPool = new ObjectPool<Assets.Scripts.UI_Components.Map>(CreatePooledNeptuneMap, null, null, null, true, 0, 50);
        UranusMapPool = new ObjectPool<Assets.Scripts.UI_Components.Map>(CreatePooledUranusMap, null, null, null, true, 0, 50);

        BeeSmallProjectilePool = new ObjectPool<Projectile>(CreatePooledBeeSmallProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        BeeMediumProjectilePool = new ObjectPool<Projectile>(CreatePooledBeeMediumProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        BumblebeeShotProjectilePool = new ObjectPool<Projectile>(CreatePooledBumblebeeShotProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        FlagshipShotProjectilePool = new ObjectPool<Projectile>(CreatePooledFlagshipShotProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        RocketProjectilePool = new ObjectPool<Projectile>(CreatePooledRocketProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        HumanSmallProjectilePool = new ObjectPool<Projectile>(CreatePooledHumanSmallProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        HumanMediumProjectilePool = new ObjectPool<Projectile>(CreatePooledHumanMediumProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        BeamProjectilePool = new ObjectPool<Projectile>(CreatePooledBeamProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        SplitShotProjectilePool = new ObjectPool<Projectile>(CreatePooledSplitShotProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        QueenSmallProjectilePool = new ObjectPool<Projectile>(CreatePooledQueenSmallProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        QueenLargeProjectilePool = new ObjectPool<Projectile>(CreatePooledQueenLargeProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        StrikerBombProjectilePool = new ObjectPool<Projectile>(CreatePooledStrikerBombProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        RocketExplosionProjectilePool = new ObjectPool<Projectile>(CreatePooledRocketExplosionProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);
        FireBargeExplosionProjectilePool = new ObjectPool<Projectile>(CreatePooledFireBargeExplosionProjectile, OnTakeProjectileFromPool, OnReturnProjectileToPool, OnDestroyPoolObject, true, 0, 50);

        EmptyObstacleListObjectPool = new ObjectPool<ObstacleMap>(CreatePooledEmptyObstacleList, null, null, null, true, 0, 250);
        MazeObstacleListObjectPool = new ObjectPool<ObstacleMap>(CreatePooledMazeObstacleList, null, null, null, true, 0, 250);
        ThreePathsObstacleListObjectPool = new ObjectPool<ObstacleMap>(CreatePooledThreePathsObstacleList, null, null, null, true, 0, 250);
        ForestObstacleListObjectPool = new ObjectPool<ObstacleMap>(CreatePooledForestObstacleList, null, null, null, true, 0, 250);
        TheWallObstacleListObjectPool = new ObjectPool<ObstacleMap>(CreatePooledTheWallObstacleList, null, null, null, true, 0, 250);

        CollisionAsteroidPool = new ObjectPool<CollisionAsteroid>(CreatePooledCollisionAsteroid, null, null, OnDestroyPoolObject, true, 0, 250);
        CollisionAsteroidShardPool = new ObjectPool<CollisionAsteroid>(CreatePooledCollisionAsteroidShard, null, null, OnDestroyPoolObject, true, 0, 250);
        AsteroidPiecePool = new ObjectPool<AsteroidPiece>(CreatePooledAsteroidPiece, null, null, OnDestroyPoolObject, true, 0, 250);
        MiningAsteroidPool = new ObjectPool<MiningAsteroid>(CreatePooledMiningAsteroid, null, null, OnDestroyPoolObject, true, 0, 250);

        SquadPool = new ObjectPool<Squad>(CreatePooledSquad, OnTakeSquadFromPool, OnReturnSquadToPool, OnDestroyPoolObject, true, 0, 100);
        CarrierSquadPool = new ObjectPool<CarrierSquad>(CreatePooledCarrierSquad, null, null, null, true, 0, 250);

        AggressiveCommandPool = new ObjectPool<Aggressive>(CreatePooledAggressiveCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        BombingRunCommandPool = new ObjectPool<BombingRun>(CreatePooledBombingRunCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        ChargeCommandPool = new ObjectPool<Charge>(CreatePooledChargeCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        CircleSquadCommandPool = new ObjectPool<CircleSquad>(CreatePooledCircleSquadCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        ClosestFriendlyCommandPool = new ObjectPool<ClosestFriendly>(CreatePooledClosestFriendlyCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        FullRetreatCommandPool = new ObjectPool<FullRetreat>(CreatePooledFullRetreatCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        GuardCommandPool = new ObjectPool<Guard>(CreatePooledGuardCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        InAndOutCommandPool = new ObjectPool<InAndOut>(CreatePooledInAndOutCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        MiningCommandPool = new ObjectPool<Mining>(CreatePooledMiningCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        MoveToRandomCommandPool = new ObjectPool<MoveToRandom>(CreatePooledMoveToRandomCommand, OnTakeCommandFromPool, OnReturnCommandToPool, null, true, 0, 100);
        PatrolCommandPool = new ObjectPool<Patrol>(CreatePooledPatrolCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        RetreatCommandPool = new ObjectPool<Retreat>(CreatePooledRetreatCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        ScoutingCommandPool = new ObjectPool<Scouting>(CreatePooledScoutingCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        SwipeSquadCommandPool = new ObjectPool<SwipeSquad>(CreatePooledSwipeSquadCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        HoldCommandPool = new ObjectPool<Hold>(CreatePooledHoldCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
        HealCommandPool = new ObjectPool<Heal>(CreatePooledHealCommand, OnTakeCommandFromPool, OnReturnCommandToPool, OnDestroyPoolObject, true, 0, 100);
