        ...
        public void RecolorAnimationSprites()
        {
            ...
            if (Ship.FleetShip.HasCachedSprite)
            {
                ...
                else
                {
                    ...
                    {
                        RecoloredSprites[i] = Ship.FleetShip.LoadCachedSprite(i + 1, "ship", ConfigData.ShipSizes[Ship.ShipType], Ship.Squad.SavedSquad.Color, ConfigData.FifthSizePixelsPerUnit); // skips the first sprite because that's the base sprite
                    }
